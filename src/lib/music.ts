...
export const PLAYLIST: Track[] = [
  {
    ...
    src: ["music/vivaldi-fruehling-1-allegro.ogg", "music/vivaldi-fruehling-1-allegro.mp3"],
  ...
  },
  {
    ...
    artist: "Vivaldi · John Harrison / Wichita State University Chamber Players",
    src: ["music/vivaldi-herbst-1-allegro.ogg", "music/vivaldi-herbst-1-allegro.mp3"],
    license: "CC BY-SA 4.0",
    url: "https://johnharrison.cc/the-four-seasons/",
  },
  {
    ...
    artist: "Vivaldi · John Harrison / Wichita State University Chamber Players",
    src: ["music/vivaldi-winter-2-largo.ogg", "music/vivaldi-winter-2-largo.mp3"],
    license: "CC BY-SA 4.0",
    url: "https://johnharrison.cc/the-four-seasons/",
  },
];
